          ...
          Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  athlete.nextMarkNo != -1
                      ? '${markNames[athlete.nextMarkNo!]![2]}${markNames[athlete.nextMarkNo!]![0]}マークを案内中'
                      : '',
                  style: TextStyle(
                    fontSize: 12,
              ...
              Row(
                children: [
                  TextButton(
                    onPressed: () {
                      cancelPassed(athlete.userId!, athlete.nextMarkNo!);
                    },
                    child: const Text('通過取り消し', style: TextStyle(fontSize: 12)),
                  ),
                  TextButton(
                    onPressed: () {
                      forcePassed(athlete.userId!, athlete.nextMarkNo!);
                    },
                    child: const Text(
                      '次のマークを案内',
    ...
    return Row(
      children: [
        ...
        Padding(
          ...
          child: Text(
            athlete.nextMarkNo != -1
                ? '${markNames[athlete.nextMarkNo!]![0]}マークの案内中'
                : '',
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        TextButton(
          onPressed: () {
            forcePassed(athlete.userId!, 1);
          },
          child: const Text('上通過'),
        ),
        TextButton(
          onPressed: () {
            forcePassed(athlete.userId!, 2);
          },
          child: const Text('サイド通過'),
        ),
        TextButton(
          onPressed: () {
            forcePassed(athlete.userId!, 3);
          },
